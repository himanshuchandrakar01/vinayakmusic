                        ...
                        <div class="card">
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    ...
                                    <div class="mb-5">
                                           <button type="button" class="btn btn-primary btn-block fw-600" data-toggle="modal" data-target="#myModal">Guest login</button>
                                    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-default" role="form" action="{{ route('guest.login') }}" method="POST">
                @csrf
          <input type="email" name="guest_email" class="form-control" placeholder="{{ translate('Email')}}"><br>
          <input type="text" name="guest_name" class="form-control" placeholder="{{ translate('Name')}}"><br>
          <input type="number" name="guest_phone" class="form-control" placeholder="{{ translate('Phone')}}">
          <br>
