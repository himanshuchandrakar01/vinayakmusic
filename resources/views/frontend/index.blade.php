...
<div id="icon_wrapper">
    <a style="" target="_blank" class="fuse_social_icons_links" data-nonce="5483288f72" data-title="facebook" href="https://www.facebook.com/vinayakmusicworld/">
        ...
        <a target="_blank" class="fuse_social_icons_links" data-nonce="5483288f72" data-title="instagram" href="https://www.instagram.com/vinayakmusicworld/">
           <img class="social_media" src="{{ static_asset('assets/img/vinayak_insta.png') }}"></a><br>
           
               <a target="_blank" class="fuse_social_icons_links" data-nonce="5483288f72" data-title="youtube" href="https://youtube.com/channel/UCEpKAiRfM5apwn6sHlA7r9Q">
...
<div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
    <div class="row">
        <div class="col-sm-7">
                ...
                <div class="col-sm-5">
                    <a style="float: right;" href="https://vinayakmusic.com/categories" class="btn btn-primary buy-now fw-600">View all</a>
                </div>
                </div>
    <div class="row">

            <div class="col-md-3 col-sm-6">
                <a href="https://vinayakmusic.com/index.php/category/vinyl-records-0ib9b"><img class="mobile_image" height="200" src="{{static_asset('assets/img/category/vinylrecord.gif') }}"></a>
                <br>
                <div class="d-block text-reset mt-2 text-truncate vinyl_record">Vinyl Record</div>
                <!-- <h5 style="text-align:center"></h5> -->
            </div>
            <div class="col-md-3 col-sm-6">
                <a href="https://vinayakmusic.com/category/audio-cd-7bx8l"><img class="mobile_image" height="200" src="{{static_asset('assets/img/category/audio_cd.gif') }}"></a>
                <br>
                <div class="d-block text-reset mt-2 text-truncate audio_cd">Audio CD</div>
            </div>
            <div class="col-md-3 col-sm-6">
                <a href="https://vinayakmusic.com/category/VIDEO-CD-rO10P"><img class="mobile_image" height="200" src="{{static_asset('assets/img/category/video.gif') }}"></a>
                <br>
                <div class="d-block text-reset mt-2 text-truncate video_cd">Video CD</div>
            </div>
            <div class="col-md-3 col-sm-6">
                <a href="https://vinayakmusic.com/category/AUDIO-CASSETTES-hfm2r"><img class="mobile_image" height="200" src="{{static_asset('assets/img/category/audio_casette.gif') }}"></a>
                <br>
                <div class="d-block text-reset mt-2 text-truncate audio_cassette">Audio Cassettes</div>
            </div>
        </div>
                    <!-- @if (count($featured_categories) > 0)
                        <ul class="list-unstyled mb-0 row gutters-5">
                            @foreach ($featured_categories as $key => $category)
                                <li class="minw-0 col-md-3 mt-3">
                                    <a href="{{ route('products.category', $category->slug) }}" class="d-block rounded bg-white p-2 text-reset shadow-sm">
                                        <img
                                            ...
                                            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';"
                                        >
                                        <div style="text-align: center;" class="text-truncate fs-12 fw-600 mt-2 opacity-70">{{ $category->getTranslation('name') }}</div>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
...
@section('script')
    <script>
        $(document).ready(function(){
            ...
            $.post('{{ route('home.section.offer') }}', {_token:'{{ csrf_token() }}'}, function(data){
                $('#section_offer').html(data);
                AIZ.plugins.slickCarousel();
            });
