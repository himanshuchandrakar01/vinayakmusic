                    ...
                    <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                @foreach ($carts as $key => $cartItem)
                                    @php
                                        ...
                                        $total = $total +  (convert_price($cartItem['price']) + $cartItem['tax']) * $cartItem['quantity'];
                                    ...
                                    <li class="list-group-item px-0 px-lg-3">
                                        <div class="row gutters-5">
                                            <div class="col-lg-5 d-flex">
                                                ...
                                                <span class="fs-14 opacity-80">
                                                    {{ $product_name_with_choice }}
                                                    <br>
                                                     <?php $qty = 0; foreach ($product->stocks as $key => $stock) { $qty += $stock->qty; } 
                                                            if($qty < 1 ){
                                                                echo'<button type="button" class="btn btn-xs btn-danger ">SOLD OUT</button>';
                                                            }
                                                        ?>
                                                </span>
                                            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 text-center text-md-right">
                                ...
                                @if( ( $total>convert_price(1000) ) || (Session::get('country_code') != 'IN')    )
                                @if(Auth::check())
                                ...
                                @endif
                                @else
                                    <small class="text-danger" type="button">{{ translate('Minimum order amount is ')}} {{single_price(1000)}}</small><br>
                                    <button class="btn btn-outline-primary" type="button">{{ translate('Continue to Shipping')}}</button>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="mb-5">
                                           <button type="button" class="btn btn-primary btn-block fw-600" data-toggle="modal" data-target="#mycheckModal">Guest login</button>
                                    </div>
...
<div class="modal fade" id="mycheckModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-default" role="form" action="{{ route('guest.login') }}" method="POST">
                @csrf
          <input type="email" name="email" class="form-control" placeholder="{{ translate('Email')}}"><br>
          <input type="text" name="name" class="form-control" placeholder="{{ translate('Name')}}"><br>
          <input type="number" name="phone" class="form-control" placeholder="{{ translate('Phone')}}">
          <br>
