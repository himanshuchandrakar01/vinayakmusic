                            ...
                            @if (count($order->orderDetails) > 0)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a class="btn btn-soft-warning btn-icon btn-circle btn-sm" href="{{ route('invoice.download', $order->id) }}
                                        " title="{{ translate('Download Invoice') }}">
                                            <i class="las la-download"></i>
                                        </a>
                                        <?php } ?>
                                        <?php if($order->awb_number) { ?>
                                        <a class="btn btn-soft-info btn-icon btn-circle btn-sm" href="{{ route('tracking',$order->id)}}" title="{{ translate('Track your order') }}"><i class="fa fa-truck"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            @endif
