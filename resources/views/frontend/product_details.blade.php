        ...
        <a target="_blank" class="fuse_social_icons_links" data-nonce="5483288f72" data-title="twitter" href="https://www.instagram.com/vinayakmusicworld/">
           <img class="social_media" src="{{ static_asset('assets/img/vinayak_insta.png') }}"></a><br>
               <a target="_blank" class="fuse_social_icons_links" data-nonce="5483288f72" data-title="instagram" href="https://youtube.com/channel/UCEpKAiRfM5apwn6sHlA7r9Q">
                   <img class="social_media" src="{{ static_asset('assets/img/vinayak_youtube.png') }}"></a>
</div>
@section('content')
                        ...
                        <div class="sticky-top z-3 row gutters-10">
                            ...
                            <div class="col-12 col-md-auto w-md-80px order-2 order-md-1 mt-3 mt-md-0">
                                <div class="aiz-carousel product-gallery-thumb" data-items='5' data-nav-for='.product-gallery' data-vertical='true' data-vertical-sm='false' data-focus-select='true' data-arrows='true'>
                                    ...
                                    @foreach ($detailedProduct->stocks as $key => $stock)
                                        @if ($stock->image != null)
                                            <div class="carousel-box c-pointer border p-1 rounded" data-variation="{{ $stock->variant }}" style="height:100% !important;">
                                                <img
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                <div class="col-12">
                                 ...
                                 @if(discount_in_percentage($detailedProduct) > 0)
                                    <span class="badge-custom badge_discount">{{ translate('OFF') }}<span class="box ml-1">&nbsp;{{discount_in_percentage($detailedProduct)}}%</span></span>
                                @endif
                            ...
                            @else
                                @if(home_price($detailedProduct) != home_discounted_price($detailedProduct))
                                    <div class="row no-gutters mt-3">
                                        <div class="col-sm-2">
                                            <div class="opacity-50 my-2">{{ translate('Standard Price')}}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row no-gutters my-2">
                                        <div class="col-sm-2">
                                            <div class="opacity-50">{{ translate('Selling Price')}}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                            <div class="">
                            ...
                            <form id="option-choice-form">
                                ...
                                <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                                    <div class="col-sm-2">
                                        <div class="opacity-50 my-2">
                                            ...
                                            <?php if (Session::has('country_code') && (Session::get('country_code') == 'IN')) { ?>
                                                 <br><small>{{ translate('With GST')}} ( {{ $detailedProduct->getTranslation('gst_percent')}}% )</small>
                                            <?php   } ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-10">
                             ...
                             <div class="row no-gutters pb-3" id="">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="my-2" style="color:black;">
                                           ...
                                           <?php echo $detailedProduct->getTranslation('sku'); ?>
                                        </div>
                                    </div>
                                </div>
                                <hr>
                            ...
                            <!-- <div class="row"> -->
                                <p class="p-3 fs-16 fw-600 text-reset">{{ translate('Short Description')}}</p>
                                    <!-- </div> -->
                                    <hr>

                            <!-- <div class="row"> -->
                                <div class="p-4" style="border: 1px solid #dcd9d9;">
                        ...
                        <!-- <hr> -->
                         <!-- <div class="tab-pane fade" id="tab_default_5">
                            ...
                            <div class="mt-3">
                                ...
                                <button type="button" class="btn btn-primary out-of-stock fw-600 d-none" data-toggle="modal" data-target="#myModalNotify">
                                    <i class="la la-cart-arrow-down"></i> {{ translate('Notify me')}}
                                </button>
                            </div>

                            <div class="modal fade" id="myModalNotify" role="dialog">
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <form action="{{ route('notify-data') }}" method="post">
                                          @csrf
                                          <input type="hidden" class="form-control" name="product_id" value="{{ $detailedProduct->getTranslation('name') }}">
                                          <p><input type="text" class="form-control" name="name" placeholder="Enter Your Name"></p>
                                          <p><input type="number" class="form-control" name="contact_no" placeholder="Enter Contact Number"></p>
                                          <p><input type="email" class="form-control" name="email" placeholder="Enter Email Address"></p>
                                          <p><button class="btn btn-primary mr-2 fw-600" type="submit">Submit</button></p>
                                      </form>
                                    </div>
                ...
                <div class="col-xl-9 order-0 order-xl-1">
                    <div class="bg-white mb-3 shadow-sm rounded">
                        <div class="nav border-bottom aiz-nav-tabs">
                            <a href="#tab_default_1" data-toggle="tab" class="p-3 fs-16 fw-600 text-reset active show">{{ translate('Description')}}</a>
                           <!--  <a href="#tab_default_5" data-toggle="tab" class="p-3 fs-16 fw-600 text-reset">{{ translate('Short Description')}}</a> -->
                            <a href="#tab_default_6" data-toggle="tab" class="p-3 fs-16 fw-600 text-reset">{{ translate('Additional Information')}}</a>
                        ...
                        <div class="tab-content pt-0">
                            <div class="tab-pane fade active show" id="tab_default_1">
                                <div class="p-3">
                                    <div class="mw-100 overflow-hidden text-left aiz-editor-data" style="border: 1px solid #dcd9d9; padding: 10px;">
                                        <?php echo $detailedProduct->getTranslation('description'); ?>
                                    </div>
                                </div>
                           ...
                           <!--  <div class="tab-pane fade" id="tab_default_5">
                            ...
                            <div class="tab-pane fade" id="tab_default_6">
                                <div class="p-4">
                                    <div class="mw-100 overflow-hidden text-left aiz-editor-data">
                                        <!-- {{ home_discounted_price($detailedProduct) }} -->
                                        <!-- <?php echo $detailedProduct->getTranslation('additional_information'); ?> -->
                                        <h6 style="border: 1px solid #dcd9d9; padding: 10px;">Weight <?php echo $detailedProduct->getTranslation('product_weight'); ?>gm</h6>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="p-3">
                            <div class="aiz-carousel gutters-5 half-outside-arrow d-flex" data-items="5" data-xl-items="3" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
