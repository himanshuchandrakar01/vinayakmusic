...
<body>
	<div>
		...
		<div style="background: #eceff4;padding: 1rem;">
			<table>
				<tr>
				    <td style="font-size: 1.9rem;" class="strong">{{  translate('BANK DETAIL') }}</td>
					<td class="text-right">
						@if($logo != null)
			...
			<table>
			    <tr>
			        <td style"font-size: 20px;">Thank you for your order</td>
			    </tr>
			    <tr>
			        <td>Hi Vinayak,</td><br>

                    <td>Thanks for your order. It’s on-hold until we confirm that payment has been received. In the meantime, here’s a reminder of what you ordered:</td>
			    </tr>
				<!--<tr>-->
				<!--	<td style="font-size: 1rem;" class="strong">{{ get_setting('site_name') }}</td>-->
				<!--	<td class="text-right"></td>-->
				<!--</tr>-->
				<tr>Our Bank Details</tr>
				<tr>
					...
					<!--Flat no. 102, ground floor,Abhijat Apartment,<br>-->
     <!--                       Near PG Umathe, Kanya Shala,<br>-->
     <!--                            Shanti Nagar, Raipur, Chhattisgarh, PIN – 492001<br>-->
     <!--                            Phone: 9630098332<br>-->
            ...
            <tr>
                <td>
                    <table>
        				...
        				<tr><td  width="50%" class="gry-color small">{{ $billing_address->address }}, {{ $billing_address->city }}, {{ $billing_address->country }}</td></tr>
        				...
        				<tr><td  width="50%" class="gry-color small">{{ $shipping_address->address }}, {{ $shipping_address->city }}, {{ $shipping_address->country }}</td></tr>
