<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap bg-white">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <!-- Product -->
                ...
                <!--    <a href="#" class="aiz-side-nav-link">-->
                <!--        <i class="las la-money-bill aiz-side-nav-icon"></i>-->
                <!--        <span class="aiz-side-nav-text">{{translate('Upload Tracking Details')}}</span>-->
                <!--        <span class="aiz-side-nav-arrow"></span>-->
                <!--    </a>-->
                <!--    <ul class="aiz-side-nav-list level-2">-->
                        
                <!--            <li class="aiz-side-nav-item">-->
                <!--                <a href="{{ route('tracking-details')}}" class="aiz-side-nav-link">-->
                <!--                    <span class="aiz-side-nav-text">{{translate('Add Tracking detail')}}</span>-->
                <!--                </a>-->
                <!--            </li> -->
                <!--            <li class="aiz-side-nav-item">-->
                <!--                <a href="{{ route('tracking-list')}}" class="aiz-side-nav-link">-->
                <!--                    <span class="aiz-side-nav-text">{{translate('List')}}</span>-->
                <!--                </a>-->
                <!--            </li>-->
                <!--    </ul>-->
            ...
            <!-- Sellers -->
               ...
               <li class="aiz-side-nav-item">
                                <a href="{{ route('notify.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['notify.index'])}}">
                                    <i class="las la-folder-open aiz-side-nav-icon"></i>
                                    <span class="aiz-side-nav-text">{{ translate('Notify Me List') }}</span>
                                </a>
                </li>
            <!-- Reports -->
                @if(Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('staff_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['staff_report.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Staff Report') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('shipping-report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['shipping-report.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Shipping Report') }}</span>
                                </a>
                            </li>
                            <!--<li class="aiz-side-nav-item">-->
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('14', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customclearance.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Custom Clearance Charges')}}</span>
                                </a>
                            </li>
                            ...
                            <li class="aiz-side-nav-item">
                                ...
                                <ul class="aiz-side-nav-list level-3">
                                   ...
                                   <!--  <li class="aiz-side-nav-item">
                                        <a href="{{route('weight.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['weight.index','weight.edit','weight.update'])}}">
                                            <span class="aiz-side-nav-text">{{translate('Weight Group')}}</span>
                                        </a>
                                    </li> -->
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('zone.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['zone.index','zone.edit','zone.update'])}}">
                                            <span class="aiz-side-nav-text">{{translate('Add Zones')}}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('zone-country.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['zone-country.index','zone-country.edit','zone-country.update'])}}">
                                            <span class="aiz-side-nav-text">{{translate('Zone countries')}}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('zone-wise-amt.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['zone-wise-amt.index','zone-wise-amt.edit','zone-wise-amt.update'])}}">
                                            <span class="aiz-side-nav-text">{{translate('Zone Wise Charge')}}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('domestic-weight.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['domestic-weight.index','domestic-weight.edit','domestic-weight.update'])}}">
                                            <span class="aiz-side-nav-text">{{translate('Domestic Weight Charges')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
