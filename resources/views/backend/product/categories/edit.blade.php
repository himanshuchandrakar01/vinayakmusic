                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">
                            {{translate('Additional Charges For Foreign Countries')}}
                        </label>
                        <div class="col-md-9">
                            <input type="number" name="additional_charge_fc" value="{{ $category->additional_charge_fc }}" class="form-control" id="order_level" placeholder="{{translate('Additional Charges')}}">
