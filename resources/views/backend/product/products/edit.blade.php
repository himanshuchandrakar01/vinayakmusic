            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" lang="en" class="form-control" name="hsn_code" placeholder="{{translate('HSN code')}}" value="{{$product->hsn_code}}">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('With GST')}}</label>
                            <div class="col-lg-6">
                                <input type="number" placeholder="{{translate('With GST')}}" name="gst_price" class="form-control" value="{{$product->gst_price}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('GST Percent')}}</label>
                            <div class="col-lg-6">
                                <input type="number" placeholder="{{translate('GST Percent')}}" name="gst_percent" class="form-control" value="{{$product->gst_percent}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                 <input type="text" placeholder="{{translate('Product Weight')}}" name="product_weight" class="form-control" value="{{$product->product_weight}}" required>
                            </div>
                        </div>
                        <br>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Additional Information')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                            <div class="col-lg-9">
                                <textarea class="aiz-text-editor" name="additional_information">{{ $product->getTranslation('additional_information', $lang) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <textarea name="meta_short_description" rows="8" class="form-control">{{ $product->meta_short_description }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
