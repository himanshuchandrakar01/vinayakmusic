            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="unit" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" disabled="">
                            </div>
                        </div> -->
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Product HSN code')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" id="unit_gst" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Unit price') }}" name="unit_price" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">With GST </label>
                            <div class="col-md-6">
                                <input type="number" id="tot_amount" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('With GST') }}" name="gst_price" class="form-control" required>
                            </div>
                        </div>
                         <div class="form-group row">
                            <label class="col-md-3 col-from-label">GST Percent </label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Enter GST Percent') }}" name="gst_percent" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Product Weight')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Product Weight') }}" name="product_weight" class="form-control" required>
                            </div>
                        </div>
                        <br>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Additional Information')}}</label>
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="additional_information"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Short Description')}}</label>
                            <div class="col-md-8">
                                <textarea name="meta_short_description" rows="8" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
...
<script>
        $(document).ready(function() {
            $('#unit_gst').keyup(function(ev) {
                var total = $('#unit_gst').val() * 1;
