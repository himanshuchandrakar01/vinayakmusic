...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('/products/{id}/edit', 'ProductController@admin_product_edit')->name('products.edit');
    ...
    Route::get('/notify', 'NotifyMeController@index')->name('notify.index');
    Route::get('/notify/destroy/{id}', 'NotifyMeController@destroy')->name('notify.destroy');
    ...
    Route::get('tracking-details', 'TrackingController@index')->name('tracking-details');
    Route::post('tracking-details', 'TrackingController@tracking_store')->name('tracking-details');
    Route::get('tracking-list', 'TrackingController@tracking_list')->name('tracking-list');
    Route::get('tracking-list/destroy/{id}', 'TrackingController@destroy')->name('tracking-list.destroy');
    ...
    Route::post('/update_orders', 'OrderController@update_order')->name('orders.update_link');
    ...
    Route::get('/staff_report', 'ReportController@staff_details')->name('staff_report.index');
    ...
    Route::get('/shipping-report', 'ShippingReportController@index')->name('shipping-report.index');
    // Route::post('/shipping-store', 'ShippingReportController@store')->name('shipping-store');
    ...
    Route::get('/weight/destroy/{id}', 'WeightController@destroy')->name('weight.destroy');
    Route::post('/weight/status', 'WeightController@updateStatus')->name('weight.status');

    Route::resource('zone', 'ZoneController');
    Route::get('/zone/edit/{id}', 'ZoneController@edit')->name('zone.edit');
    Route::get('/zone/destroy/{id}', 'ZoneController@destroy')->name('zone.destroy');
    Route::post('/zone/status', 'ZoneController@updateStatus')->name('zone.status');

    Route::resource('customclearance', 'CustomClearanceController');
    Route::get('/customclearance/edit/{id}', 'CustomClearanceController@edit')->name('customclearance.edit');
    Route::get('/customclearance/destroy/{id}', 'CustomClearanceController@destroy')->name('customclearance.destroy');

    Route::resource('zone-country', 'ZoneCountryController');
    Route::get('/zone-country/edit/{id}', 'ZoneCountryController@edit')->name('zone-country.edit');
    Route::get('/zone-country/destroy/{id}', 'ZoneCountryController@destroy')->name('zone-country.destroy');
    Route::post('/zone-country/status', 'ZoneCountryController@updateStatus')->name('zone-country.status');

    Route::resource('zone-wise-amt', 'ZoneWiseController');
    Route::get('/zone-wise-amt/edit/{id}', 'ZoneWiseController@edit')->name('zone-wise-amt.edit');
    Route::get('/zone-wise-amt/destroy/{id}', 'ZoneWiseController@destroy')->name('zone-wise-amt.destroy');
    Route::post('/zone-wise-amt/status', 'ZoneWiseController@updateStatus')->name('zone-wise-amt.status');

    Route::resource('domestic-weight', 'DomesticWeightController');
    Route::get('/domestic-weight/edit/{id}', 'DomesticWeightController@edit')->name('domestic-weight.edit');
    Route::get('/domestic-weight/destroy/{id}', 'DomesticWeightController@destroy')->name('domestic-weight.destroy');
    // Route::post('/domestic-weight/status', 'DomesticWeightController@updateStatus')->name('domestic-weight.status');

    Route::view('/system/update', 'backend.system.update')->name('system_update');
    Route::view('/system/server-status', 'backend.system.server_status')->name('system_server');

    // uploaded files
    Route::any('/uploaded-files/file-info', 'AizUploadControlltoer@file_info')->name('uploaded-files.info');
