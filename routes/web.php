...
Route::get('/get_category_link/{id}', function($id) {
    echo "https://vinayakmusic.com/category/".DB::table('categories')->where('id',$id)->first()->slug;
});
...
// Route::get('/guest/login', 'HomeController@guest_login')->name('guest.login');
Route::post('/guest/login', 'HomeController@guest_login')->name('guest.login');
...
//Notify me
Route::post('/notify-data', 'NotifyMeController@store_notify')->name('notify-data');

Route::group(['middleware' => ['country']], function() { 
    Route::get('/', 'HomeController@index')->name('home');
    Route::post('/home/section/featured', 'HomeController@load_featured_section')->name('home.section.featured');
    Route::post('/home/section/offer', 'HomeController@load_offer_section')->name('home.section.offer');
...
// });
//Checkout Routes
// Route::group(['prefix' => 'checkout', 'middleware' => ['user', 'verified', 'unbanned','country']], function() {
Route::group(['prefix' => 'checkout', 'middleware' => ['user', 'verified', 'unbanned','country']], function() {
...
// Route::get('/delete', 'HomeController@deleteitem')->name('delete');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::get('tracking/{id}', 'PurchaseHistoryController@tracking')->name('tracking');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('packing/{order_id}', 'PackingController@packing_download')->name('packing.download');
    Route::get('bank/{order_id}', 'BankController@bank_details')->name('bank');
...
//about
Route::get('/about', 'HomeController@about_details')->name('about');
Route::get('/grading', 'HomeController@grading_details')->name('grading');
